...
Several representations of statistical distributions are available in plotly, such as [histograms](histograms.md), [violin plots](violin.md), [box plots](box-plots.md) (see [the complete list here](placeholders/statistical-charts.md)). It is also possible to combine several representations in the same plot.
