...
1. You jump right in to **examples** of how to make [basic charts](placeholders/basic-charts.md), [statistical charts](placeholders/statistical-charts.md), [scientific charts](placeholders/scientific-charts.md), [financial charts](placeholders/financial-charts.md), [maps](placeholders/maps.md), and [3-dimensional charts](placeholders/3d-charts.md).
